...
<option value="Zimbabwe">Zimbabwe</option>  
                                        ...
                                        <div class="col-sm-8">
                                             <div class="form-group">
                                      <p>By clicking submit, you certify that all the personal information you provided are valid including the bank account whose information is provided above belongs to you and you are legally permitted to use it for this purpose.</p>
                                      </div>
                                      </div>
                                      <div class="col-sm-4">
                                            <button class="btn btn-block btn-primary mr5 pull-right">Submit</button>
                                        </div>
                                            </div>
                                        </div><!-- panel-footer -->
                                    </div><!-- panel -->
